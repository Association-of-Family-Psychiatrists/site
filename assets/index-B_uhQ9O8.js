const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ListservView-4rvIBRkQ.js","assets/ContentPage-Cgy6pVkb.js","assets/ContentPage-DoamoPAO.css","assets/AwardRecognitionView-hVxgs-ee.js","assets/AwardRecognitionView-BbLzey1E.css","assets/FamilyTreatmentView-BCHGkBZ3.js","assets/ArticlesView-DYCqZsQP.js","assets/WebResourcesView-DfY_tbNz.js","assets/AACAPView-UG_QGUDc.js","assets/FamilyCenteredView-BkF7IZMR.js","assets/PsychiatricResourcesView-kDRu4Vlv.js","assets/BooksView-V-SYdi0B.js","assets/CultureFamilyResourcesView-BslnS8Aw.js","assets/CulturalAnthropologyView-Dl3yVl3L.js","assets/CurriculumInAdultPsychiatricResidencyTrainingView-DQzGcBoI.js","assets/TrainingProgramsInFamilyPsychiatryView-CGp1Do6y.js","assets/MembershipView-D9EsFCzx.js","assets/MembershipView-C2M84lW3.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni="RemoteStore";class fR{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.ha=[],this.Pa=new Map,this.Ta=new Set,this.Ia=[],this.Ea=i,this.Ea.No(a=>{r.enqueueAndForget(async()=>{Mi(this)&&(Z(Ni,"Restarting streams for network reachability change."),await async function(c){const u=Ve(c);u.Ta.add(4),await Vi(u),u.da.set("Unknown"),u.Ta.delete(4),await Ca(u)}(this))})}),this.da=new hR(r,s)}}async function Ca(t){if(Mi(t))for(const e of t.Ia)await e(!0)}async function Vi(t){for(const e of t.Ia)await e(!1)}function Mi(t){return Ve(t).Ta.size===0}async function qm(t,e,n){if(!Oi(e))throw e;t.Ta.add(1),await Vi(t),t.da.set("Offline"),n||(n=()=>ZA(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{Z(Ni,"Retrying IndexedDB access"),await n(),t.Ta.delete(1),await Ca(t)})}function Gm(t,e){return e().catch(n=>qm(t,n,e))}async function ka(t){const e=Ve(t),n=cr(e);let r=e.ha.length>0?e.ha[e.ha.length-1].batchId:qc;for(;dR(e);)try{const s=await eR(e.localStore,r);if(s===null){e.ha.length===0&&n.N_();break}r=s.batchId,pR(e,s)}catch(s){await qm(e,s)}Wm(e)&&Km(e)}function dR(t){return Mi(t)&&t.ha.length<10}function pR(t,e){t.ha.push(e);const n=cr(t);n.M_()&&n.Y_&&n.Z_(e.mutations)}function Wm(t){return Mi(t)&&!cr(t).F_()&&t.ha.length>0}function Km(t){cr(t).start()}async function gR(t){cr(t).ta()}async function mR(t){const e=cr(t);for(const n of t.ha)e.Z_(n.mutations)}async function _R(t,e,n){const r=t.ha.shift(),s=eu.from(r,e,n);await Gm(t,()=>t.remoteSyncer.applySuccessfulWrite(s)),await ka(t)}async function yR(t,e){e&&cr(t).Y_&&await async function(r,s){if(function(a){return dA(a)&&a!==B.ABORTED}(s.code)){const i=r.ha.shift();cr(r).O_(),await Gm(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await ka(r)}}(t,e),Wm(t)&&Km(t)}async function _d(t,e){const n=Ve(t);n.asyncQueue.verifyOperationInProgress(),Z(Ni,"RemoteStore received new credentials");const r=Mi(n);n.Ta.add(3),await Vi(n),r&&n.da.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Ta.delete(3),await Ca(n)}async function vR(t,e){const n=Ve(t);e?(n.Ta.delete(2),await Ca(n)):e||(n.Ta.add(2),await Vi(n),n.da.set("Unknown"))}function cr(t){return t.Va||(t.Va=function(n,r,s){const i=Ve(n);return i.ra(),new lR(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{e_:()=>Promise.resolve(),n_:gR.bind(null,t),i_:yR.bind(null,t),X_:mR.bind(null,t),ea:_R.bind(null,t)}),t.Ia.push(async e=>{e?(t.Va.O_(),await ka(t)):(await t.Va.stop(),t.ha.length>0&&(Z(Ni,`Stopping write stream with ${t.ha.length} pending writes`),t.ha=[]))})),t.Va}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class su{constructor(e,n,r,s,i){this.asyncQueue=e,this.timerId=n,this.targetTimeMs=r,this.op=s,this.removalCallback=i,this.deferred=new Rr,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(a=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,n,r,s,i){const a=Date.now()+r,l=new su(e,n,a,s,i);return l.start(r),l}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new ue(B.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Qm(t,e){if(Or("AsyncQueue",`${e}: ${t}`),Oi(t))return new ue(B.UNAVAILABLE,`${e}: ${t}`);throw t}class ER{constructor(){this.queries=yd(),this.onlineState="Unknown",this.ba=new Set}terminate(){(function(n,r){const s=Ve(n),i=s.queries;s.queries=yd(),i.forEach((a,l)=>{for(const c of l.ya)c.onError(r)})})(this,new ue(B.ABORTED,"Firestore shutting down"))}}function yd(){return new Lr(t=>Sm(t),Rm)}function wR(t){t.ba.forEach(e=>{e.next()})}var vd,Ed;(Ed=vd||(vd={})).Ca="default",Ed.Cache="cache";const bR="SyncEngine";class TR{constructor(e,n,r,s,i,a){this.localStore=e,this.remoteStore=n,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.au={},this.uu=new Lr(l=>Sm(l),Rm),this.cu=new Map,this.lu=new Set,this.hu=new Vt(pe.comparator),this.Pu=new Map,this.Tu=new tu,this.Iu={},this.Eu=new Map,this.du=gs.lr(),this.onlineState="Unknown",this.Au=void 0}get isPrimaryClient(){return this.Au===!0}}async function IR(t,e,n){const r=PR(t);try{const s=await function(a,l){const c=Ve(a),u=et.now(),f=l.reduce((_,S)=>_.add(S.key),wt());let p,g;return c.persistence.runTransaction("Locally write mutations","readwrite",_=>{let S=Xo(),k=wt();return c.Bs.getEntries(_,f).next(O=>{S=O,S.forEach((H,F)=>{F.isValidDocument()||(k=k.add(H))})}).next(()=>c.localDocuments.getOverlayedDocuments(_,S)).next(O=>{p=O;const H=[];for(const F of l){const j=cA(F,p.get(F.key).overlayedDocument);j!=null&&H.push(new Fr(F.key,j,vm(j.value.mapValue),kn.exists(!0)))}return c.mutationQueue.addMutationBatch(_,u,H,l)}).next(O=>{g=O;const H=O.applyToLocalDocumentSet(p,k);return c.documentOverlayCache.saveOverlays(_,O.batchId,H)})}).then(()=>({batchId:g.batchId,changes:Cm(p)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(a,l,c){let u=a.Iu[a.currentUser.toKey()];u||(u=new Vt(we)),u=u.insert(l,c),a.Iu[a.currentUser.toKey()]=u}(r,s.batchId,n),await xa(r,s.changes),await ka(r.remoteStore)}catch(s){const i=Qm(s,"Failed to persist write");n.reject(i)}}function wd(t,e,n){const r=Ve(t);if(r.isPrimaryClient&&n===0||!r.isPrimaryClient&&n===1){const s=[];r.uu.forEach((i,a)=>{const l=a.view.Da(e);l.snapshot&&s.push(l.snapshot)}),function(a,l){const c=Ve(a);c.onlineState=l;let u=!1;c.queries.forEach((f,p)=>{for(const g of p.ya)g.Da(l)&&(u=!0)}),u&&wR(c)}(r.eventManager,e),s.length&&r.au.j_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function AR(t,e){const n=Ve(t),r=e.batch.batchId;try{const s=await YA(n.localStore,e);Jm(n,r,null),Xm(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await xa(n,s)}catch(s){await Hc(s)}}async function RR(t,e,n){const r=Ve(t);try{const s=await function(a,l){const c=Ve(a);return c.persistence.runTransaction("Reject batch","readwrite-primary",u=>{let f;return c.mutationQueue.lookupMutationBatch(u,l).next(p=>(ze(p!==null,37113),f=p.keys(),c.mutationQueue.removeMutationBatch(u,p))).next(()=>c.mutationQueue.performConsistencyCheck(u)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(u,f,l)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(u,f)).next(()=>c.localDocuments.getDocuments(u,f))})}(r.localStore,e);Jm(r,e,n),Xm(r,e),r.sharedClientState.updateMutationState(e,"rejected",n),await xa(r,s)}catch(s){await Hc(s)}}function Xm(t,e){(t.Eu.get(e)||[]).forEach(n=>{n.resolve()}),t.Eu.delete(e)}function Jm(t,e,n){const r=Ve(t);let s=r.Iu[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(n?i.reject(n):i.resolve(),s=s.remove(e)),r.Iu[r.currentUser.toKey()]=s}}async function xa(t,e,n){const r=Ve(t),s=[],i=[],a=[];r.uu.isEmpty()||(r.uu.forEach((l,c)=>{a.push(r.Ru(c,e,n).then(u=>{var f;if((u||n)&&r.isPrimaryClient){const p=u?!u.fromCache:(f=void 0)===null||f===void 0?void 0:f.current;r.sharedClientState.updateQueryState(c.targetId,p?"current":"not-current")}if(u){s.push(u);const p=ru.Rs(c.targetId,u);i.push(p)}}))}),await Promise.all(a),r.au.j_(s),await async function(c,u){const f=Ve(c);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",p=>L.forEach(u,g=>L.forEach(g.ds,_=>f.persistence.referenceDelegate.addReference(p,g.targetId,_)).next(()=>L.forEach(g.As,_=>f.persistence.referenceDelegate.removeReference(p,g.targetId,_)))))}catch(p){if(!Oi(p))throw p;Z(QA,"Failed to update sequence numbers: "+p)}for(const p of u){const g=p.targetId;if(!p.fromCache){const _=f.xs.get(g),S=_.snapshotVersion,k=_.withLastLimboFreeSnapshotVersion(S);f.xs=f.xs.insert(g,k)}}}(r.localStore,i))}async function SR(t,e){const n=Ve(t);if(!n.currentUser.isEqual(e)){Z(bR,"User change. New user:",e.toKey());const r=await Hm(n.localStore,e);n.currentUser=e,function(i,a){i.Eu.forEach(l=>{l.forEach(c=>{c.reject(new ue(B.CANCELLED,a))})}),i.Eu.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await xa(n,r.ks)}}function PR(t){const e=Ve(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=AR.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=RR.bind(null,e),e}class Zo{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Pa(e.databaseInfo.databaseId),this.sharedClientState=this.pu(e),this.persistence=this.yu(e),await this.persistence.start(),this.localStore=this.wu(e),this.gcScheduler=this.Su(e,this.localStore),this.indexBackfillerScheduler=this.bu(e,this.localStore)}Su(e,n){return null}bu(e,n){return null}wu(e){return JA(this.persistence,new KA,e.initialUser,this.serializer)}yu(e){return new jm(nu.fi,this.serializer)}pu(e){return new tR}async terminate(){var e,n;(e=this.gcScheduler)===null||e===void 0||e.stop(),(n=this.indexBackfillerScheduler)===null||n===void 0||n.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Zo.provider={build:()=>new Zo};class CR extends Zo{constructor(e){super(),this.cacheSizeBytes=e}Su(e,n){ze(this.persistence.referenceDelegate instanceof Yo,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new DA(r,e.asyncQueue,n)}yu(e){const n=this.cacheSizeBytes!==void 0?Dt.withCacheSize(this.cacheSizeBytes):Dt.DEFAULT;return new jm(r=>Yo.fi(r,n),this.serializer)}}class nc{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>wd(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=SR.bind(null,this.syncEngine),await vR(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new ER}()}createDatastore(e){const n=Pa(e.databaseInfo.databaseId),r=function(i){return new oR(i)}(e.databaseInfo);return function(i,a,l,c){return new uR(i,a,l,c)}(e.authCredentials,e.appCheckCredentials,r,n)}createRemoteStore(e){return function(r,s,i,a,l){return new fR(r,s,i,a,l)}(this.localStore,this.datastore,e.asyncQueue,n=>wd(this.syncEngine,n,0),function(){return gd.C()?new gd:new nR}())}createSyncEngine(e,n){return function(s,i,a,l,c,u,f){const p=new TR(s,i,a,l,c,u);return f&&(p.Au=!0),p}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}async terminate(){var e,n;await async function(s){const i=Ve(s);Z(Ni,"RemoteStore shutting down."),i.Ta.add(5),await Vi(i),i.Ea.shutdown(),i.da.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(n=this.eventManager)===null||n===void 0||n.terminate()}}nc.provider={build:()=>new nc};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XR(t,e,n){let r;return r=t?t.toFirestore(e):e,r}function JR(t,e,n){t=rc(t,xn);const r=rc(t.firestore,e_),s=XR(t.converter,e);return YR(r,[qR(zR(r),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,kn.none())])}function YR(t,e){return function(r,s){const i=new Rr;return r.asyncQueue.enqueueAndForget(async()=>IR(await DR(r),s,i)),i.promise}(UR(t),e)}function ZR(){return new uu("serverTimestamp")}(function(e,n=!0){(function(s){Es=s})(ys),cs(new Cr("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new e_(new fI(r.getProvider("auth-internal")),new gI(a,r.getProvider("app-check-internal")),function(u,f){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new ue(B.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Wo(u.options.projectId,f)}(a,s),a);return i=Object.assign({useFetchStreams:n},i),l._setSettings(i),l},"PUBLIC").setMultipleInstances(!0)),sr(Hf,zf,e),sr(Hf,zf,"esm2017")})();const eS={apiKey:"AIzaSyC_acZxWWtGDDFPdxBaa2TR6JkQcw0k0Fk",authDomain:"afp-site-c1bd9.firebaseapp.com",projectId:"afp-site-c1bd9",storageBucket:"afp-site-c1bd9.firebasestorage.app",messagingSenderId:"533749269819",appId:"1:533749269819:web:47c5dbe921ef3aae83e31e",measurementId:"G-W9TQ1EE3PB"},tS=bg(eS),nS=FR(tS);lI();const rS={class:"footer"},sS={class:"footer-bottom"},iS={class:"footer-nav"},oS={class:"subscribe-box"},aS={key:0,class:"subscribe-message"},lS={class:"footer-copy"},cS={__name:"Footer",setup(t){const e=ot(""),n=ot(""),r=async()=>{try{const s=e.value.trim().toLowerCase();if(!s){n.value="Please enter a valid email.";return}await JR(LR(nS,"mailingList",s),{email:s,subscribedAt:ZR()}),n.value="Thank you for subscribing!",e.value=""}catch(s){s.code==="permission-denied"?n.value="You’re already subscribed.":(console.error("Unexpected error adding email:",s),n.value="An error occurred. Please try again later.")}};return(s,i)=>(ie(),he("footer",rS,[U("div",sS,[U("nav",iS,[re(Pe(it),{to:"/"},{default:Ke(()=>i[1]||(i[1]=[Qe("Home")])),_:1,__:[1]}),re(Pe(it),{to:"/about"},{default:Ke(()=>i[2]||(i[2]=[Qe("About")])),_:1,__:[2]}),re(Pe(it),{to:"/events"},{default:Ke(()=>i[3]||(i[3]=[Qe("Events")])),_:1,__:[3]}),re(Pe(it),{to:"/contact"},{default:Ke(()=>i[4]||(i[4]=[Qe("Contact")])),_:1,__:[4]})]),U("div",oS,[i[6]||(i[6]=U("h3",null,"Join our mailing list",-1)),U("form",{onSubmit:Zp(r,["prevent"])},[xo(U("input",{"onUpdate:modelValue":i[0]||(i[0]=a=>e.value=a),type:"email",placeholder:"Enter your email",required:"",class:"email-input"},null,512),[[Dl,e.value]]),i[5]||(i[5]=U("button",{type:"submit",class:"subscribe-button"},"Subscribe",-1))],32),n.value?(ie(),he("p",aS,je(n.value),1)):Ut("",!0)]),U("p",lS," © "+je(new Date().getFullYear())+" Association of Family Psychiatrists. All rights reserved. ",1)])]))}},uS=kt(cS,[["__scopeId","data-v-32f87464"]]),hS={class:"layout"},fS={class:"page-content"},dS={__name:"App",setup(t){return(e,n)=>(ie(),he(ut,null,[U("div",hS,[re(Rw),U("main",fS,[re(Pe(Sc))])]),re(uS)],64))}},pS=kt(dS,[["__scopeId","data-v-aa0b9fe9"]]),gS="modulepreload",mS=function(t){return"/site/"+t},kd={},Ge=function(e,n,r){let s=Promise.resolve();if(n&&n.length>0){let a=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),c=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=a(n.map(u=>{if(u=mS(u),u in kd)return;kd[u]=!0;const f=u.endsWith(".css"),p=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${p}`))return;const g=document.createElement("link");if(g.rel=f?"stylesheet":gS,f||(g.as="script"),g.crossOrigin="",g.href=u,c&&g.setAttribute("nonce",c),document.head.appendChild(g),f)return new Promise((_,S)=>{g.addEventListener("load",_),g.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${u}`)))})}))}function i(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return s.then(a=>{for(const l of a||[])l.status==="rejected"&&i(l.reason);return e().catch(i)})},_S="/site/assets/afp-logo-DTm74N-G.png";function hu(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ur=hu();function c_(t){Ur=t}var ri={exec:()=>null};function Ce(t,e=""){let n=typeof t=="string"?t:t.source;const r={replace:(s,i)=>{let a=typeof i=="string"?i:i.source;return a=a.replace(Ct.caret,"$1"),n=n.replace(s,a),r},getRegex:()=>new RegExp(n,e)};return r}var Ct={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i")},yS=/^(?:[ \t]*(?:\n|$))+/,vS=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ES=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Li=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,wS=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,fu=/(?:[*+-]|\d{1,9}[.)])/,u_=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,h_=Ce(u_).replace(/bull/g,fu).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),bS=Ce(u_).replace(/bull/g,fu).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),du=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,TS=/^[^\n]+/,pu=/(?!\s*\])(?:\\.|[^\[\]\\])+/,IS=Ce(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",pu).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),AS=Ce(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,fu).getRegex(),Oa="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",gu=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,RS=Ce("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",gu).replace("tag",Oa).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),f_=Ce(du).replace("hr",Li).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Oa).getRegex(),SS=Ce(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",f_).getRegex(),mu={blockquote:SS,code:vS,def:IS,fences:ES,heading:wS,hr:Li,html:RS,lheading:h_,list:AS,newline:yS,paragraph:f_,table:ri,text:TS},xd=Ce("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Li).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Oa).getRegex(),PS={...mu,lheading:bS,table:xd,paragraph:Ce(du).replace("hr",Li).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",xd).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Oa).getRegex()},CS={...mu,html:Ce(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",gu).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ri,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Ce(du).replace("hr",Li).replace("heading",` *#{1,6} *[^
]`).replace("lheading",h_).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},kS=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,xS=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,d_=/^( {2,}|\\)\n(?!\s*$)/,OS=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Da=/[\p{P}\p{S}]/u,_u=/[\s\p{P}\p{S}]/u,p_=/[^\s\p{P}\p{S}]/u,DS=Ce(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,_u).getRegex(),g_=/(?!~)[\p{P}\p{S}]/u,NS=/(?!~)[\s\p{P}\p{S}]/u,VS=/(?:[^\s\p{P}\p{S}]|~)/u,MS=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,m_=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,LS=Ce(m_,"u").replace(/punct/g,Da).getRegex(),FS=Ce(m_,"u").replace(/punct/g,g_).getRegex(),__="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",US=Ce(__,"gu").replace(/notPunctSpace/g,p_).replace(/punctSpace/g,_u).replace(/punct/g,Da).getRegex(),$S=Ce(__,"gu").replace(/notPunctSpace/g,VS).replace(/punctSpace/g,NS).replace(/punct/g,g_).getRegex(),BS=Ce("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,p_).replace(/punctSpace/g,_u).replace(/punct/g,Da).getRegex(),jS=Ce(/\\(punct)/,"gu").replace(/punct/g,Da).getRegex(),HS=Ce(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),zS=Ce(gu).replace("(?:-->|$)","-->").getRegex(),qS=Ce("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",zS).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ta=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,GS=Ce(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",ta).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),y_=Ce(/^!?\[(label)\]\[(ref)\]/).replace("label",ta).replace("ref",pu).getRegex(),v_=Ce(/^!?\[(ref)\](?:\[\])?/).replace("ref",pu).getRegex(),WS=Ce("reflink|nolink(?!\\()","g").replace("reflink",y_).replace("nolink",v_).getRegex(),yu={_backpedal:ri,anyPunctuation:jS,autolink:HS,blockSkip:MS,br:d_,code:xS,del:ri,emStrongLDelim:LS,emStrongRDelimAst:US,emStrongRDelimUnd:BS,escape:kS,link:GS,nolink:v_,punctuation:DS,reflink:y_,reflinkSearch:WS,tag:qS,text:OS,url:ri},KS={...yu,link:Ce(/^!?\[(label)\]\((.*?)\)/).replace("label",ta).getRegex(),reflink:Ce(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ta).getRegex()},sc={...yu,emStrongRDelimAst:$S,emStrongLDelim:FS,url:Ce(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},QS={...sc,br:Ce(d_).replace("{2,}","*").getRegex(),text:Ce(sc.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},uo={normal:mu,gfm:PS,pedantic:CS},Us={normal:yu,gfm:sc,breaks:QS,pedantic:KS},XS={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Od=t=>XS[t];function on(t,e){if(e){if(Ct.escapeTest.test(t))return t.replace(Ct.escapeReplace,Od)}else if(Ct.escapeTestNoEncode.test(t))return t.replace(Ct.escapeReplaceNoEncode,Od);return t}function Dd(t){try{t=encodeURI(t).replace(Ct.percentDecode,"%")}catch{return null}return t}function Nd(t,e){var i;const n=t.replace(Ct.findPipe,(a,l,c)=>{let u=!1,f=l;for(;--f>=0&&c[f]==="\\";)u=!u;return u?"|":" |"}),r=n.split(Ct.splitPipe);let s=0;if(r[0].trim()||r.shift(),r.length>0&&!((i=r.at(-1))!=null&&i.trim())&&r.pop(),e)if(r.length>e)r.splice(e);else for(;r.length<e;)r.push("");for(;s<r.length;s++)r[s]=r[s].trim().replace(Ct.slashPipe,"|");return r}function $s(t,e,n){const r=t.length;if(r===0)return"";let s=0;for(;s<r&&t.charAt(r-s-1)===e;)s++;return t.slice(0,r-s)}function JS(t,e){if(t.indexOf(e[1])===-1)return-1;let n=0;for(let r=0;r<t.length;r++)if(t[r]==="\\")r++;else if(t[r]===e[0])n++;else if(t[r]===e[1]&&(n--,n<0))return r;return n>0?-2:-1}function Vd(t,e,n,r,s){const i=e.href,a=e.title||null,l=t[1].replace(s.other.outputLinkReplace,"$1");r.state.inLink=!0;const c={type:t[0].charAt(0)==="!"?"image":"link",raw:n,href:i,title:a,text:l,tokens:r.inlineTokens(l)};return r.state.inLink=!1,c}function YS(t,e,n){const r=t.match(n.other.indentCodeCompensation);if(r===null)return e;const s=r[1];return e.split(`
...
`,t=t.substring(g.length+1),c=!0),!c){const H=this.rules.other.nextBulletRegex(S),F=this.rules.other.hrRegex(S),j=this.rules.other.fencesBeginRegex(S),z=this.rules.other.headingBeginRegex(S),le=this.rules.other.htmlBeginRegex(S);for(;t;){const se=t.split(`
`,1)[0];let A;if(g=se,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),A=g):A=g.replace(this.rules.other.tabCharGlobal,"    "),j.test(g)||z.test(g)||le.test(g)||H.test(g)||F.test(g))break;if(A.search(this.rules.other.nonSpaceChar)>=S||!g.trim())f+=`
`+A.slice(S);else{if(_||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||j.test(p)||z.test(p)||F.test(p))break;f+=`
`+g}!_&&!g.trim()&&(_=!0),u+=se+`

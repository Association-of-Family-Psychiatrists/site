<template>
    <ContentPage 
      title="Child and Adolescent Centered Families"
  ...
  const contentSections = [
    {
      heading: "About Child and Adolescent Centered Families",
      subheading: "Many extremely challenging behavioral health problems in childhood and adolescence are best treated with family based treatment. Here are some examples with a brief description of each:",
      paragraphs: []
    },
    {
      heading: "Conduct Disorder and Delinquency",
      subheading: "",
      paragraphs: [
    ...
    {
      heading: "Disruptive and Oppositional Defiant Disorder",
      subheading: "",
      paragraphs: [
    ...
    {
      heading: "Adolescent Substance Abuse",
      subheading: "",
      paragraphs: [

...
onMounted(() => {
  ...
  script.src = 'https://www.paypal.com/sdk/js?client-id=ATudL1zTvsJmaJ-kS6hmdf7L6FLM3mfdFMnkle5EGbA2Jfq12VfNagnkk_W8kDXr7J_jekw_dTEBx3RS&currency=USD&components=buttons'
  script.onload = async () => {
